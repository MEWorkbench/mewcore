...
public abstract class PARSIMONIOUSSimulationTest extends AbstractSimulationTest{
	...
	protected void setParameters()
	{
		...
		method = new PARSIMONIOUS(super.model);
...
//	@Test
	...
	{
		method.setProperty(SimulationProperties.PARSIMONIUS_PROBLEM, null);
		// Sendo registada sem objecto esta propriedade não dá exception
...
//	@Test
	...
	{		
		...
		method.setProperty(SimulationProperties.PARSIMONIUS_PROBLEM, "Valor");
		// Não dá exception mas apresenta a seguinte mensagem:
...
//	@Test
	...
	{
		method.setProperty(SimulationProperties.PARSIMONIUS_OBJECTIVE_VALUE, null);
		// Sendo registada sem objecto esta propriedade não dá exception
...
//	@Test
	public void runParsimoniusObjValTypeMismach() throws Exception
	{
		...
		method.setProperty(SimulationProperties.PARSIMONIUS_OBJECTIVE_VALUE, "Valor");
		// Não dá exception mas apresenta a seguinte mensagem:
