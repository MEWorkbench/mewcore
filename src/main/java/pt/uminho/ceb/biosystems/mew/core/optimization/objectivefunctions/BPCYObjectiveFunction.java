...
public class BPCYObjectiveFunction implements IObjectiveFunction, Serializable {
	...
	public BPCYObjectiveFunction(String biomassId, String desiredFluxId, double substrateValue) {
