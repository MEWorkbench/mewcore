...
import pt.uminho.ceb.biosystems.mew.mewcore.strainoptimization.configuration.GenericConfiguration;
...
public class JecoliGenericConfiguration extends GenericConfiguration implements IJecoliConfiguration {
    ...
    public int getMaximumNumberOfFunctionEvaluations() {
        return getDefaultValue(JecoliOptimizationProperties.MAXIMUM_NUMBER_OF_FUNCTION_EVALUATIONS,80000);
    }
