 ...
 */
public abstract class JecoliSCOM<T extends JecoliGenericConfiguration,E extends IJecoliOptimizationStrategyConverter>
        extends AbstractStrainOptimizationAlgorithm<T> {

    protected SimulationSteadyStateControlCenter simulationSteadyStateControlCenter;
    protected E optimizationStrategyConverter;

    public JecoliSCOM(E optimizationStrategyConverter) {
    ...
    public ArchiveManager configureDefaultArchive(IAlgorithm optimizationAlgorithm,IEvaluationFunction evaluationFunction) {
        ...
        ArchiveManager archive = new ArchiveManagerBestSolutions(optimizationAlgorithm, InsertionStrategy.ADD_ON_SINGLE_EVALUATION_FUNCTION_EVENT, InsertionStrategy.ADD_SMART, ProcessingStrategy.PROCESS_ARCHIVE_ON_SINGLE_EVALUATION_FUNCTION_EVENT, true);
    ...
    public IStrainOptimizationResultSet processAlgorithmResult(ArchiveManager archive,T configuration,AbstractMultiobjectiveEvaluationFunction<IRepresentation> evaluationFunction,IAlgorithmResult result,
    ...
    protected AbstractMultiobjectiveEvaluationFunction computeStrainOptimizationEvaluationFunction(T configuration, ISteadyStateDecoder decoder) throws Exception {
        ...
        return new StrainOptimizationEvaluationFunction(
                model,
                decoder,
                environmentalConditions,
                solver,
                simulationMethodList,
                mapOF2Sim,
                referenceFD,
                isMaximization,
                1,
