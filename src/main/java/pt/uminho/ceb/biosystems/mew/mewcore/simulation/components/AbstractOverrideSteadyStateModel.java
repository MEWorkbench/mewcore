...
public abstract class AbstractOverrideSteadyStateModel implements IOverrideReactionBounds {

	
	protected ISteadyStateModel model;
	
	public AbstractOverrideSteadyStateModel() {
	}	
		
	public ReactionConstraint getReactionConstraint(int reactionIndex)
	{
		return model.getReactionConstraint(reactionIndex);
	}
