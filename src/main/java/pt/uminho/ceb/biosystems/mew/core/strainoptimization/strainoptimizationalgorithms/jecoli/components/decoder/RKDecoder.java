...
public class RKDecoder implements ISteadyStateDecoder {
	...
	public RKDecoder(ISteadyStateModel model) {
		this.model = model;
	...
	public RKDecoder(ISteadyStateModel model, List<Integer> notAllowedReactionKnockouts) {
		this.model = model;
