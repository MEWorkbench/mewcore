...
public class WeightedYIELDObjectiveFunction implements IObjectiveFunction, Serializable{
	...
	public WeightedYIELDObjectiveFunction(String biomassId, String desiredFluxId, Double alpha, SolverType lpSolver, Double minBiomassValue) {
		...
		this.minBiomassValue = minBiomassValue;
	}
...
//				center.forceSolverCleanup();
	...
	public ObjectiveFunctionType getType() {
		return ObjectiveFunctionType.WEIGHTED_YIELD;
	}
	...
	public String getShortString() {
		return "WYIELD~"+desiredFluxId+"~"+alpha+"~"+minBiomassValue;
	}
	...
	public String getBuilderString() {
		return getType() + "("+biomassId+","+desiredFluxId+","+alpha+","+lpSolver+","+minBiomassValue+")";
	}
