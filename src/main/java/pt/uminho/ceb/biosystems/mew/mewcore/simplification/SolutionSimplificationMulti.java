...
public class SolutionSimplificationMulti implements Serializable {
	...
	public SolutionSimplificationMulti(ISteadyStateModel model, IndexedHashMap<IObjectiveFunction, String> objFunctions, FluxValueMap referenceFD, EnvironmentalConditions envCond, SolverType solver) {
		this.model = model;
	...
	public SolutionSimplificationResult simplifyReactionsSolution(GeneticConditions initialSolution, SteadyStateMultiSimulationResult initialRes) throws Exception {
		...
		SolutionSimplificationResult optimizationSimplification = new SolutionSimplificationResult(finalRes.getSimulationResultForMethod(objectiveFunctions.getValueAt(0)), finalSolution, objectiveFunctions.getIndexArray(), finalFitnesses);
	...
	public SolutionSimplificationResult simplifyGenesSolution(GeneticConditions initialSolution, SteadyStateMultiSimulationResult initialRes) throws Exception {
