...
import pt.uminho.ceb.biosystems.mew.mewcore.cmd.clustertools.ConfigurationGenerator;
import pt.uminho.ceb.biosystems.mew.mewcore.cmd.clustertools.GeneratorConstants;

public class MainMTBest {
	...
	private static void processRunner(String confFile) throws Exception {
		TestRunnerMTBest runner = new TestRunnerMTBest(confFile);
		try {
			runner.run();
		} catch (Exception e) {
			e.printStackTrace();
