...
import pt.uminho.ceb.biosystems.mew.mewcore.simulation.mfa.utils.AlgebraUtils;
...
// 		DoubleMatrix2D gcPseudoInverseMatrix = Matrix.inverse(gcTransposeMatrix);//pseudoInverse(gcMatrix);; NOTE: change to algebra.inverse() by pmaia, 2015/04/20, 15:30h
 		DoubleMatrix2D gcPseudoInverseMatrix = algebra.inverse(gcTransposeMatrix);//pseudoInverse(gcMatrix);;
