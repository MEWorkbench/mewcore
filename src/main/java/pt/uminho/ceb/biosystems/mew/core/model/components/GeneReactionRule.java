...
public class GeneReactionRule implements Serializable{
	
	private static final long serialVersionUID = 1L;
	
	protected AbstractSyntaxTree<DataTypeEnum, IValue> rule;
	
	public GeneReactionRule(AbstractSyntaxTree<DataTypeEnum, IValue> rule){
		if(rule == null)
	...
	public GeneReactionRule(String rule) throws ParseException{
