...
//		}
	...
	public SteadyStateModel addDrainReaction (int metaboliteIndex, boolean out, boolean in) throws Exception
	{
		...
		IndexedHashMap<String,pt.uminho.ceb.biosystems.mew.mewcore.model.components.Reaction> newReactions = 
			new IndexedHashMap<String,pt.uminho.ceb.biosystems.mew.mewcore.model.components.Reaction>();
	...
	{
		IndexedHashMap<String,pt.uminho.ceb.biosystems.mew.mewcore.model.components.Metabolite> newMetabolites = 
			new IndexedHashMap<String,pt.uminho.ceb.biosystems.mew.mewcore.model.components.Metabolite>();
