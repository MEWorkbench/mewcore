...
public class GeneReactionKnockoutDecoder extends SteadyStateKnockoutDecoder {
	
	private static final long	serialVersionUID	= -7254501112776803961L;
	
	public GeneReactionKnockoutDecoder(ISteadyStateGeneReactionModel model) {
		super(model);
	}
	
	public GeneReactionKnockoutDecoder(ISteadyStateGeneReactionModel model, List<Integer> notAllowedGeneKnockouts) {
