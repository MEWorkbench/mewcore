...
/**
 * Class for spawning concrete method algorithms. Note: The algorithm classes have to contain at least an empty constructor
 */
public class AbstractOptimizationMethodsFactory {
    /**
     *Map of methods
     */
    ...
    /**
     * Initializes the instance variable mapMethods to the value in the parameter
...
//		methodProperties = new HashMap<String, Object>();
     ...
     * @throws UnregistaredMethodException - (Note typo name of the class) The method is not registered in the factory
     */
     ...
     * @throws UnregistaredMethodException  - The method is not registered in the factory
     */
     ...
     * @throws RegistMethodException When the method is already registered in the factory
