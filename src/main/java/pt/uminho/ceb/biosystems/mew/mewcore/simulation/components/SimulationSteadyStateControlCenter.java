...
import pt.uminho.ceb.biosystems.mew.mewcore.simulation.formulations.LMOMA;
import pt.uminho.ceb.biosystems.mew.mewcore.simulation.formulations.MOMA;
...
public class SimulationSteadyStateControlCenter extends AbstractSimulationSteadyStateControlCenter implements Serializable{
	...
	static{
		...
		mapMethods.put(SimulationProperties.PARSIMONIUS,  PARSIMONIOUS.class);
		...
		mapMethods.put(TurnOverProperties.MIMBL, MiMBl.class);
