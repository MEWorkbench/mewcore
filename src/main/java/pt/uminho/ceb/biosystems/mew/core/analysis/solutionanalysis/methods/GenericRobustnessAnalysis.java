...
public class GenericRobustnessAnalysis extends AbstractSolutionAnalysisMethod implements ISolutionAnalysis {
	...
	public GenericRobustnessAnalysis(String targetID, String solverId) {
		super(NUM_OUTPUTS);
		_targetID = targetID;
	...
	public double[] analyse(SteadyStateSimulationResult result) {
		...
		lmoma.setSolverType(getSolverId());
		...
		lpVariabilityOriginalMin.setSolverType(getSolverId());
		...
		while (currStep < numSteps) {
			...
			lpVariabilityCurrent.setSolverType(getSolverId());
